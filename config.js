...
window.LANDING_CONFIG = {
  ...
  version: 'v1.2.0',
  releaseDate: '2026-07-4',
  // 下载链接（替换为新版本时只需改这两行）
  downloads: {
    windows: 'https://github.com/wuzhenmin/fapiao_assistant_release/releases/download/v1.2.0/runjinbu-windows.zip',
    macos:   'https://github.com/wuzhenmin/fapiao_assistant_release/releases/download/v1.2.0/runjinbu-macos.zip',
  },
  // 所有版本入口（可选）
